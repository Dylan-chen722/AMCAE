# Description: main function for training autoencoder
import argparse
...
def main(argv=None): 
    ...
    parser.add_argument('--version', type=str, default="CAE_v1.0", help='experimental version')
    parser.add_argument('--description', type=str, default='training CAE model', help='experimental description')
    parser.add_argument('--script', type=str, default='CAE', help='script for training')
    ...
    parser.add_argument('--mask_size', type=int, default=10, help='the size for random mask')
    parser.add_argument('--mask_ratio', type=int, default=0.8, help='the ratio for random mask')
